...
outloop:
	bge t2,t1, outloopexit #will go to outloopexit if true (nested loop)
	
li t3, 0
print_str(dollar) # for dollar to be print at the beginning of everyline
write_to_buffer(0x24)
	inloop: #nestedloop to print the star dollar accordingly 
		bge t3, t2,inloopexit
